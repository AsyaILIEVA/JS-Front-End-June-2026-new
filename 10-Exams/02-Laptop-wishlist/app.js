...
function solve() {
  ...
  function publish() {
    ...
    //document represents the HTML page currently loaded in the browser.
    //createElement() tells JavaScript:
    //"Create a new HTML element."
    // button is created but not visible yet <button></button>

    editBtn.classList.add("btn");
    //Add the class btn to the button:
