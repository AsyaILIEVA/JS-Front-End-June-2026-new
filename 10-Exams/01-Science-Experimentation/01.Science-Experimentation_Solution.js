function manageChemicals(input) {
  ...
  for (let i = 0; i < n; i++) {
    ...
    //.push() adds a new object to the array
    //object has three properties: name, quantity, formula
    //name = "chem1", quantity = Number("100") = 100, formula = null => no formula stored yet
  }
